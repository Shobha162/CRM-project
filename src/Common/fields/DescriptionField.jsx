        ...
        <Controller
          ...
          render={({ field }) => (
            <textarea
              ...
              disabled={disabled}
              className={
                "w-full h-[38px] px-2.5 py-2 text-sm font-poppins placeholder:font-poppins placeholder:font-medium placeholder:text-sm placeholder:leading-normal not-italic leading-normal bg-transparent font-medium outline-none border-none disabled:cursor-not-allowed resize-none transition-all" +
                (className !== "" ? ` ${className}` : "")
              }
              style={{
